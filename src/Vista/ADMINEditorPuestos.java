...
/**
 *
 * Ventana Editor Puestos
 */
public class ADMINEditorPuestos extends javax.swing.JFrame {
    ...
    public ADMINEditorPuestos(Obra obra) {
    this.obra = obra;
    ...
    public void mouseClicked(java.awt.event.MouseEvent evt) {
        if (evt.getClickCount() == 2) { // Detectar doble clic
            ...
            if (selectedRow != -1) {
                // Llamar al método que permite editar la descripción
                mostrarDescripcionEditable(selectedRow);
            }
        }
    }
});
...
private void mostrarDescripcionEditable(int selectedRow) {
    // Obtener el modelo de la tabla
    DefaultTableModel modelo = (DefaultTableModel) TablaPuestos.getModel();

    // Obtener el puesto seleccionado desde la tabla
    String descripcionActual = modelo.getValueAt(selectedRow, 2).toString();

    // Crear un JTextArea con el contenido actual de la descripción
    JTextArea textArea = new JTextArea(descripcionActual);
    textArea.setLineWrap(true);
    textArea.setWrapStyleWord(true);

    JScrollPane scrollPane = new JScrollPane(textArea);
    scrollPane.setPreferredSize(new Dimension(400, 300)); // Tamaño del cuadro de edición

    // Mostrar el cuadro de diálogo con opción de edición
    ...
    // Si el usuario selecciona "OK", guardar el cambio
    if (resultado == JOptionPane.OK_OPTION) {
        String nuevaDescripcion = textArea.getText().trim();

        // Actualizar el modelo de la tabla
        modelo.setValueAt(nuevaDescripcion, selectedRow, 2);

        // Actualizar el objeto `Puesto` en la lista
        ArrayList<Puesto> puestos = obra.getListaPuestos();
        Puesto puestoSeleccionado = puestos.get(selectedRow);
        puestoSeleccionado.setDescripcion(nuevaDescripcion);

        // Confirmar el cambio
        JOptionPane.showMessageDialog(this, "La descripción se ha actualizado correctamente.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
    }
}
...
private void ajustarAlturaFilas(JTable tabla) {
    ...
    private void initComponents() {
        ...
        ButtonModificarPuestosRiesgos = new javax.swing.JButton();
        ...
        jLabel1.setText("Editor de Puestos");

        ButtonModificarPuestosRiesgos.setBackground(new java.awt.Color(204, 153, 255));
        ButtonModificarPuestosRiesgos.setText("Modificar Puestos y Riesgos");
        ButtonModificarPuestosRiesgos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ButtonModificarPuestosRiesgosActionPerformed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(189, 189, 189))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(ButtonModificarPuestosRiesgos, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(243, 243, 243))))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(ButtonModificarPuestosRiesgos, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18))
        );
    ...
    private void ButtonModificarPuestosRiesgosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonModificarPuestosRiesgosActionPerformed
        ...
        if (filaSeleccionada == -1) {
            ...
            javax.swing.JOptionPane.showMessageDialog(null, "Debe seleccionar un puesto para modificar.");
        } else {
            // Obtener los datos del empleado seleccionado en la fila
             ...
             ADMINModificarElPuesto verModificarPuestos = new ADMINModificarElPuesto(obra, identificacion);    
             verModificarPuestos.setVisible(true);  
        }
        
        
       
    }//GEN-LAST:event_ButtonModificarPuestosRiesgosActionPerformed

    


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton ButtonModificarPuestosRiesgos;
